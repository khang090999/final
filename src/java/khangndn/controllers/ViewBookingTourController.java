...
public class ViewBookingTourController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<BookingTourDTO> result = beans.findByUsername();
            request.setAttribute("INFO", result);
        } catch (Exception e) {
            log("ERROR at ViewBookingTourController: "+e.getMessage());
        }finally
        {
            request.getRequestDispatcher("booked_tour.jsp").forward(request, response);
        }
    }
