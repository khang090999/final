 ...
 * @author KHANG NGUYEN
 */
public class InsertInfoController extends HttpServlet {
    private static final String ERROR = "error.jsp";
    private static final String SUCCESS = "ViewTourController";
    private static final String INVALID ="insert_info.jsp";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean valid = true;
            if(TourValidation.checkCode(code)==0)
            {
                valid=false;
                errorObj.setCodeError("Code can't be blank!");
            }else if(TourValidation.checkCode(code)==-1)
            {
                valid=false;
                errorObj.setCodeError("Code existed!");
            }
           ...
           if(!TourValidation.checkQuantity(quantity))
           {
            ...
            if(valid)
            {
                 ...
                 {
                     request.setAttribute("ERROR", "Insert Info failed!");
                 }
            }else
            {
            ...
            log("ERROR at InsertInfoController: "+e.getMessage());
        }finally
        {
