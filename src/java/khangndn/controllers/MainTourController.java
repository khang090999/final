...
public class MainTourController extends HttpServlet {
    ...
    private static final String INSERT = "InsertTourCategoryController";
    private static final String UPDATE = "UpdateTourController";
    private static final String EDIT = "EditTourCategoryController";
    private static final String DELETE = "DeleteTourController";
    private static final String VIEW = "ViewTourController";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           }else if(action.equals("View"))
           {
            ...
            log("ERROR at MainTourController: "+e.getMessage());
        }finally
        {
