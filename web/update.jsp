                ...
                <div class="wrap-login100">
                    <form class="login100-form validate-form" action="MainAccountController" method="POST">
                        ...
                        <div class="wrap-input100  validate-input m-b-20" data-validate="Type Full name">
                            <input class="input100" type="text" name="txtFullname" max="50" value="${requestScope.DTO.fullname}" placeholder="Name...">
                            <span class="focus-input100"></span>
                        ...
                        <div class="wrap-input100  validate-input m-b-20" data-validate="Invalid email: ex@abc.xyz">
                            <input class="input100" type="text" name="txtEmail" max="50" value="${requestScope.DTO.email}" placeholder="Email addess...">
                            <span class="focus-input100"></span>
                        ...
                        <div class="container-login100-form-btn">
                            ...
                            <c:url var="Back" value="MainAccountController" >
