                ...
                <div class="wrap-login100">
                    <form class="login100-form validate-form" action="MainTourInfoController" method="POST">
                        ...
                        <div class="wrap-input100  validate-input m-b-20" data-validate="Type Tour code ">
                            <input class="input100" type="text" readonly="true" name="txtCode" value="${requestScope.DTO.code}" placeholder="Code...">
                        ...
                        <div class="wrap-input100  validate-input m-b-20" data-validate="Adult price must be a positive number">
                            <input class="input100" type="text" name="txtAdultPrice" value="${requestScope.DTO.adultPrice}" placeholder="Adult price...">
                            <span class="focus-input100"></span>
                        ...
                        <div class="wrap-input100  validate-input m-b-20" data-validate="Kid price must be a positive number">
                            <input class="input100" type="text" name="txtKidPrice" value="${requestScope.DTO.kidPrice}" placeholder="Kid price...">
                            <span class="focus-input100"></span>
                        ...
                        <div class="wrap-input100  validate-input m-b-20" data-validate="Start date must be after today">
                            <input class="input100" type="date" name="dateStart" value="${requestScope.DTO.startDate}" placeholder="Start date...">
                            <span class="focus-input100"></span>
                        ...
                        <div class="wrap-input100  validate-input m-b-20" data-validate="End date must be after or equal Start date">
                            <input class="input100" type="date" name="dateEnd" value="${requestScope.DTO.endDate}" placeholder="End date...">
                            <span class="focus-input100"></span>
                        ...
                        <div class="wrap-input100 validate-input m-b-20" data-validate="Quantity must be a positive integer">
                            <input class="input100" type="text" name="txtQuantity" value="${requestScope.DTO.quantity}" placeholder="Quantity...">
                            <span class="focus-input100"></span>
                        ...
                        <div class="container-login100-form-btn">
                            <div class="wrap-login100-form-btn">
                               ...
                               <input type="hidden" name="id" value="${requestScope.DTO.tourID}"/>
                                ...
                                <c:param name="id" value="${requestScope.DTO.tourID}"/>
