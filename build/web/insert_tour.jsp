        ...
        <div class="limiter">
            <div class="container-login100">
                <div class="wrap-login100">
                    <form class="login100-form validate-form" action="InsertTourCategoryController" method="POST" enctype="multipart/form-data">
                        <span class="login100-form-title p-b-34">
                            Insert Tour
                        </span>
                        <div class="wrap-input100  validate-input m-b-20" data-validate="Type Tour ID">
                            <input class="input100" type="text" name="txtId" max="50" value="${requestScope.DTO.tourID}" placeholder="Tour ID...">
                        ...
                        <div class="wrap-input100  validate-input m-b-20" data-validate="Place must be less than 50 characters">
                       ...
                       <div class="wrap-input100  validate-input m-b-20" data-validate="Image is not valid">
                           <input id="imgInp" class="input100 figure-caption" type="file" name="fileInsert" value="" max="50" onchange="readURL(this)">
                            <span class="focus-input100"></span>
                        ...
                        <div class="container-login100-form-btn">
                            ...
                            <div id="file-img" class="login100-more" ></div>
                </div>  
            </div>
        </div>
