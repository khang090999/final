<%-- 
    Document   : search_cart
    Created on : Mar 2, 2019, 5:09:44 PM
    Author     : KHANG NGUYEN
--%>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="search-wrap-1 ftco-animate p-4">
                            <form action="MainCartController" method="POST" class="search-property-1">
                                <div class="row">
                                            ...
                                            <div class="form-field">
                                                <div class="select-wrap">
                                                    ...
                                                    <select name="cboStatus" class="form-control">
                                                        ...
                                                        <option>10% Paid</option>
                                                        <option>30% Paid</option>
                                                        <option>50% Paid</option>
                                                        <option>90% Paid</option>
                                                        <option>Done</option>
                                                    </select>
                                                </div>
                                            </div>
                                ...
                                <tbody>
                                    ...
                                    <form action="MainCartController" method="POST">
                                        <td>
                                            ...
                                            <select name="status" class="select-status" style="border: none;">
                                                    <option <c:if test="${param.cboStatus eq 'Canceled'}">selected="true"</c:if> >Canceled</option>
                                                    <option <c:if test="${param.cboStatus eq '10% Paid'}">selected="true"</c:if>>10% Paid</option>
                                                    <option <c:if test="${param.cboStatus eq '30% Paid'}">selected="true"</c:if>>30% Paid</option>
                                                    <option <c:if test="${param.cboStatus eq '50% Paid'}">selected="true"</c:if>>50% Paid</option>
                                                    <option <c:if test="${param.cboStatus eq '90% Paid'}">selected="true"</c:if>>90% Paid</option>
                                                    <option <c:if test="${param.cboStatus eq 'Done'}">selected="true"</c:if>>Done</option>
                                                    </select>
